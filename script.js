const translations = {
  es: {
    ...
    areaTwoCopy: "Barrios conectados para clientes que priorizan movilidad y vida diaria.",
    areaThreeTitle: "Entorno familiar",
    areaThreeCopy: "Zonas tranquilas con colegios, comunidad y espacio para instalarse.",
    ...
    teamWhyStatContact: "Atención personalizada",
    ...
    residenceThreeBedroom: "3 dormitorios",
  ...
  en: {
    ...
    areaTwoCopy: "Connected neighborhoods for clients who prioritize mobility and daily life.",
    areaThreeTitle: "Family setting",
    areaThreeCopy: "Calmer areas with schools, community and room to settle in.",
    ...
    teamLeadCopy: "Miren Fernández Atela has a strong international track record in client management, institutional relations, relocation and real estate services. Having lived in Mexico, Spain and the United States, she has built a career spanning more than three decades at prestigious organizations including Estate One, Stepsrelocation, the World Bank, IFEMA, Publiespaña and Casa Decor. She helps clients settle successfully into their new environment, giving them the reassurance of working with a professional who understands both the practical and human sides of every life transition.",
    ...
    teamWhyStatContact: "Personalized attention",
    ...
    residenceThreeBedroom: "3 Bedroom",
    residencePenthouse: "Penthouse",
...
function updateBudgetLabel(language = document.documentElement.lang || "en") {
  ...
  const amount = Number(budgetRange.value);
...
function initRevealMotion() {
  ...
  imageMotionElements.forEach((element) => {
    element.classList.add("image-reveal", "image-drift");
  });
